...
fixture-pii-selftest:
    ...
    for spec in ".gitleaks.toml=cred-aws.txt,cred-disguised.txt" \
                ".gitleaks-identity.toml=identity-bearer.txt,identity-dashed.txt,identity-email.txt,identity-gituser.txt,identity-home.txt,identity-inv-bulleted.txt,identity-inv-named.txt,identity-inv-skillmd.txt,identity-mcp.txt,identity-prefix.txt,identity-users.txt,identity-win.txt"; do
        cfg=${spec%%=*}; want=${spec#*=}
