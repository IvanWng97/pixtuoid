...
- **Every modal overlay paints on EVERY frame — including the footer-only ones.** On a classic 80×24 the office can't lay out (needs 32×31) and rendering falls to …
