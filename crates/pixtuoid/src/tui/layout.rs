...
pub use pixtuoid_core::layout::{
    ...
    Bounds, Facing, Furniture, FurnitureDef, PlantKind, PodDecor, Point, SceneLayout, Size,
    WallDecor, WallSegment, Waypoint, WaypointKind, DESK_GAP_X, DESK_GAP_Y, DESK_H, DESK_W,
