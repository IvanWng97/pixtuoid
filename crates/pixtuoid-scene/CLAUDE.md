...
- **The painter's canvas nudge can seat a creature ON furniture, and that is the accepted side of a real conflict — not a leftover of #912.** `keep_sprite_on_canvas` moves a centre-anchored creature inward so `blit_centered` does not clip …
<!-- edges:end -->
