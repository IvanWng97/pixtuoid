...
each carried their own copy until #929, and had drifted apart.
...
value it cannot name, which is why a capture still gets read. No size heuristic can stand in for that read either:
