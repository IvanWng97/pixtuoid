...
- Renamed a decoded/registered wire name → `just gen-drift-surface`, commit both `crates/*/drift-surface.json` — a stale pair narrows the drift watch silently.
