...
| Review-history census #2 — 45 merged PRs #262–#328 | escape leg **FAILS** zero-recurrence (3/7 classes recurred, ~4.4% ≈ the prior baseline — rules aimed right, adherence at review- not author-stage); stale-external-fact rounds **0**; 3 disposition drops (vs 4); arch-drift **PASS** (6 invariants verified at HEAD, 4 cross-PR seams logged); sharp-edge citation baseline 3/27 | [`mining-2026-06-262-328.md`](review-metrics/mining-2026-06-262-328.md) |
