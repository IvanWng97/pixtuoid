...
- If you're unsure whether something is a bug or intentional, read the declaration's own doc comment before filing (tests/, Raycast and site keep their edges INLINE in the guide instead)
