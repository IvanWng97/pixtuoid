...
- If you're unsure whether something is a bug or intentional, read the item's comments (its doc comment and the ones on the lines it governs) before filing (tests/, Raycast and site keep theirs in the guide)
